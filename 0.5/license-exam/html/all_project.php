        ...
        <div class="container py-2 ">
            ...
            <div class="section pt-1" id="projects">
                ...
                <div class="is-flex is-justify-content-space-between is-flex-wrap-wrap mb-3">
                    <div class="subtitle col_title row_title mb-0">Project name</div>
                    <div class="subtitle col_small row_title mb-0">Description</div>
                    <div class="subtitle col_small row_title mb-0">Start</div>
                    <div class="subtitle col_small row_title mb-0">Finish</div>
                    <div class="subtitle col_small row_title mb-0">Active</div>
