    ...
    <main>
        <div class="container py-6 ">
            <div class="section ">
                ...
                <!-- Tasks Section -->
                <div class="columns">
                    <div class="column is-fullwidth has-background-grey-lighter ">
                        <!-- Tasks Title -->
                    ...
                    <div class="column is-halfwidth has-background-white-ter ">
                        ...
                        <table class="table tickets-table  is-hoverable is-fullwidth">
                            <!-- Table Header -->
                            <thead>
                ...
                if (data.tasks) {
                    ...
                    $.each(data.tasks, function (key, value) {
                        ...
                        row.append($('<td>').append('<a href="individual_task.php?task_id=' + value.id +
                            ...
                            '&projects_id=' + value.projects_id +'">' + value.title + '</a>'));

                        row.append($('<td>').text(value.description));
                        row.append($('<td>').text("to be calculated"));

                        row.append($('<td>').append('<a href="individual_project.php?project_id=' 
                            + value.projects_id + '">'
                            + value.project + '</a></td>'));
