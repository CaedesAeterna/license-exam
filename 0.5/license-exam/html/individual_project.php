        ...
        <div class="container py-6 ">
            <div class="section py-0">
                ...
                <div class="is-flex is-justify-content-space-between is-flex-wrap-wrap">
                    ...
                    <div class="button is-success mb-2" id="createTask" style="display: none;">
                        Create task
                    </div>
                    ...
                    <div class="button mb-2" id="edit_project" style="display: none;">
                        Edit project
                    </div>
            ...
            <div class="section pb-2">
                ...
                <p class="mb-3" id="remaining"> You have remaining <span id="remaining_days"></span> days</p>
            </div>

            <div class="section pt-1" id="tasks">

                <div class="is-flex is-justify-content-space-between is-flex-wrap-wrap mb-3">
                    <div class="subtitle col_title row_title mb-0">Task
                        title/description</div>
                    <div class="subtitle col_small row_title mb-0">Time spent</div>
                    <div class="subtitle col_small row_title mb-0">Start</div>
                    <div class="subtitle col_small row_title mb-0">Finish</div>
                    <div class="subtitle col_small row_title mb-0">Status</div>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                if (data.days_remaining < 0) {
                    $('#remaining').html('You have exceeded the deadline');
                }else{
                    $('#remaining_days').html(data.days_remaining + 1);
                }
                ...
                $.each(data.tasks, function (key, value) {
                    ...
                    $.ajax({
                        ...
                        var row = $('<div class="is-flex is-justify-content-space-between is-flex-wrap-wrap mb-3" style="background-color: white;">');
