...
<body>
    ...
    <main>
        <div class="container py-6 ">
            ...
            <input type="button" class="button mx-3 is-link" id="addUsersToTask" value="Add users to task"
                style="display: none;">
            ...
            <div class="columns is-centered">
                ...
                <div class="column">
                    ...
                    <div class="section">
                        ...
                        <input type="button" class="button mx-3" id="archive_task" value="Archive"
                            style="display: none;">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#archive_task').click(async function () {
                //window.location.href = "archive_task.php?task_id=" + task_id + "&projects_id=" + projects_id;

                try {
                    const userChoice = await confirmPopUp('Are you sure you want to archive this task?');

                    if (userChoice === "confirm") {
                        $.ajax({
                            "method": "POST",
                            "url": apiLink + "archive_task",
                            "data": {
                                'task_id': task_id
