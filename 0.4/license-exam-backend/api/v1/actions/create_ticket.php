...
$ticketName = $db->escape_string($_POST['ticketName']);
$ticketDescription = $db->escape_string($_POST['ticketDescription']);


$sql = "INSERT INTO tickets (name, description, active, projects_id) 
        VALUES ( '$ticketName', '$ticketDescription',1 ,'$project_id' );";
